...
import BoatDetailsForm from "./pages/Admin/post";
import EditDeleteBoatDetails from "./pages/Admin/edit";
import ViewBoat from "./pages/Admin/view";
import Dashch from "./pages/Admin/chart";
import Login from "./pages/Admin/alogin";
import Signup from "./pages/Admin/asignup";
import SuccessCard from "./pages/success";
    ...
    <BrowserRouter>
      <div>
        ...
        <Routes>
          ...
          <Route path="/post" element={<BoatDetailsForm/>}/>
          <Route path="/edit" element={<EditDeleteBoatDetails/>}/>
          <Route path="/view" element={<ViewBoat/>}/>
          <Route path="/chart" element={<Dashch/>}/>
          <Route path="/alog" element={<Login/>}/>
          <Route path="/asign" element={<Signup/>}/>
          <Route path="/sucess" element={<SuccessCard/>}/>
