            ...
            <div className="right-section">
                <div className="signup-container">
                    <form className="signup-form" onSubmit={handleFormSubmit}>
                        <h2 className="signup-title"><i className="fas fa-user-plus"></i>Admin Signup</h2>
                        ...
                        <button className='signb'><Link to={'/ad'}>Signup</Link></button>
                      
                        <button className='lg'><Link to={'/lg'}>Login</Link></button>
                        <p><Link to={'/sg'}>sigun up as User</Link></p>
                    </form>
                </div>
            </div>
        </div>
